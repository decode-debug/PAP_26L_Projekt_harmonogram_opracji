    ...
    <div style={{ padding: '20px', fontFamily: 'Arial', color: 'white', backgroundColor: '#1a1a1a', minHeight: '100vh' }}>
      ...
      {operations.length > 0 && (
        <div style={{ marginTop: '16px', padding: '14px 24px', background: '#2a2a2a', borderRadius: '6px', border: '1px solid #444', display: 'flex', gap: '40px', flexWrap: 'wrap', alignItems: 'center' }}>
          ...
          <div>
            <span style={{ color: '#aaa', fontSize: '13px' }}>Koszt skracania (zastosowany):</span>
            <span style={{ color: '#ff6b6b', fontWeight: 'bold', fontSize: '16px', marginLeft: '10px' }}>
              {operations.reduce((sum, op) => sum + ((op.crashingCostPerDay || 0) * (op.crashedDays || 0)), 0).toLocaleString('pl-PL', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} PLN
            </span>
          </div>
          <div>
